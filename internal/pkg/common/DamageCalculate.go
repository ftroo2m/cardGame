...
func DamageCalculateToMonster(player *model.Player, monster *model.Monster, origin int) int {
	// 计算玩家对怪物造成的伤害
...
func DamageCalculateToPlayer(player model.Player, monster model.Monster, origin int) int {
	// 计算怪物对玩家造成的伤害
